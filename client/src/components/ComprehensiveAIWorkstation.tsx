...
export function ComprehensiveAIWorkstation({
  className,
  onProcessingChange,
}: AIWorkstationProps) {
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-pink-900 p-6 ${className}`}
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-purple-200">
            منصة متكاملة لجميع احتياجات الذكاء الاصطناعي - توليد، تحرير، تحليل،
            وتدريب
          </p>
        </div>
            ...
            >
              <CardHeader className="text-center">
                <div className="flex justify-center mb-3">
                  <div
                    className={`p-3 rounded-full bg-gradient-to-br ${workspace.color}`}
                  >
                    {workspace.icon}
                  </div>
                </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div
                    className={`p-3 rounded-full bg-gradient-to-br ${currentWorkspace.color}`}
                  >
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center justify-center px-6 py-3 bg-white/10 backdrop-blur-md rounded-full border border-white/20">
            <span className="text-white/80 text-sm">
              🚀 {workspaces.length} ورش عمل متخصصة • 🎯 20+ نموذج ذكاء اصطناعي
